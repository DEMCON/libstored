...
#
# test_fpga.tcl: Tcl script for re-creating project 'test_fpga'
#
# Generated by Vivado on Tue Oct 20 01:02:59 +0200 2020
...
#
# 1. This project restoration tcl script (test_fpga.tcl) that was generated.
#
...
set orig_proj_dir "[file normalize "$origin_dir/test_fpga"]"

# Create project
create_project test_fpga ./test_fpga -part xc7a50tcsg324-1
...
set files [list \
 ...
 "[file normalize "$origin_dir/../../libstored/rtl/TestStore_pkg.vhd"]"\
 "[file normalize "$origin_dir/../../../fpga/rtl/variable.vhd"]"\
 "[file normalize "$origin_dir/../../libstored/rtl/TestStore.vhd"]"\
...
set file "rtl/TestStore_pkg.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
...
set obj [get_filesets sources_1]
set_property "top" "TestStore_hdl" $obj
...
set file "[file normalize "$origin_dir/test_fpga.srcs/constrs_1/new/constr.xdc"]"
...
set obj [get_filesets constrs_1]
set_property "target_constrs_file" "[file normalize "$origin_dir/test_fpga.srcs/constrs_1/new/constr.xdc"]" $obj
...
set obj [get_filesets sim_1]
set_property "top" "test_fpga" $obj
...
puts "INFO: Project created:test_fpga"
