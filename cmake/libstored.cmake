...
function(libstored_lib libprefix libpath)
	...
	if(MSVC)
		...
		target_compile_options(${LIBSTORED_LIB_TARGET} PRIVATE -Wall -Wextra -Wdouble-promotion -Wformat=2 -Wundef -Wconversion -Wlogical-op -Wshadow -ffunction-sections -fdata-sections)
		if(LIBSTORED_DEV)
			target_compile_options(${LIBSTORED_LIB_TARGET} PRIVATE -Werror)
			target_compile_options(${LIBSTORED_LIB_TARGET} PUBLIC -fstack-protector)
		endif()
