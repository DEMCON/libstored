...
libstored for Ubuntu
====================

This directory contains files to build libstored for Ubuntu (tested with
20.04).  This builds the examples and tests for demonstration and verification
purposes.
