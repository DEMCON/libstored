...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog=__package__,
        description="ZMQ command line logging client",
    ...
    parser.add_argument(
        ...
        dest="timestamp",
        default=False,
        help="Append time stamp in csv file name",
        action="store_true",
    )
    parser.add_argument(
        "-u",
        ...
        dest="unique",
        default=False,
        help="Make sure that the log filename is unique by appending a suffix",
        action="store_true",
    )
    parser.add_argument(
        "-m",
    ...
    parser.add_argument(
        "-i", "--interval", dest="interval", type=float, default=1, help="Poll interval (s)"
    )
    parser.add_argument(
        "-d", "--duration", dest="duration", type=float, default=None, help="Poll duration (s)"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        action="append",
        help="File with list of objects to poll",
    )
    parser.add_argument(
        "-e",
        "--encrypt",
