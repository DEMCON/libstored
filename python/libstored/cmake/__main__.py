...
def generate_cmake(filename, defines):
    jenv = jinja2.Environment(loader=jinja2.FileSystemLoader(os.path.join(libstored_dir, "cmake")))
...
def main():
    ...
    parser.add_argument(
        "filename", default="FindLibstored.cmake", nargs="?", type=str, help="Output filename"
    )
