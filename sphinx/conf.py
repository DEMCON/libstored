...
release = libstored.libstored_version
...
htmlhelp_basename = 'libstoreddoc'
...
man_pages = [
    (master_doc, 'libstored', 'libstored Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'libstored', 'libstored Documentation',
     author, 'libstored', 'One line description of project.',
     'Miscellaneous'),
]
